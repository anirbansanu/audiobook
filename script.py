...
def text_to_speech_gtts_large_file(file_path, lang='en', output_file='output.mp3', chunk_size=1024):
    ...
    # Play the output file using the default media player
    try:
...
text_to_speech_gtts_large_file(args.file_path, args.lang, args.output)
